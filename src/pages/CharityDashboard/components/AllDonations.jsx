...
const AllDonations = () => {
  ...
  const getStatusBadge = (status) => {
    const statusMap = {
      ...
      confirmed: { color: 'bg-gradient-to-r from-ghibli-blue to-ghibli-teal', text: 'Confirmed ✓', icon: CheckCircleIcon },
      cancelled: { color: 'bg-ghibli-red', text: 'Cancelled', icon: ExclamationTriangleIcon },
    };
    ...
    return (
      <div className="bg-white rounded-xl shadow-ghibli border border-ghibli-brown-light p-6">
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-3 text-ghibli-brown">Loading all donations...</span>
        </div>
      </div>
    );
  }
