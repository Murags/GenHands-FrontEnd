  ...
  const renderSuccessStep = () => (
    <div className="text-center space-y-6">
      ...
      <div className="flex justify-center space-x-4">
        ...
        <button onClick={() => (window.location.href = '/donor')} className="cursor-pointer px-6 py-3 bg-ghibli-brown text-white rounded-lg font-medium hover:bg-opacity-90 transition-colors">
          View Donations
        </button>
      </div>
    </div>
